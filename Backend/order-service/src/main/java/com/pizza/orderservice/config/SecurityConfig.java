package com.pizza.orderservice.config;
...
public class SecurityConfig {
	...
	public JwtDecoder jwtDecoder() {
		logger.info("Creating JwtDecoder Bean for Order Service...");
		...
		logger.info("JwtDecoder Bean created successfully for Order Service.");
